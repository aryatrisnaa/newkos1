        ...
        <div id="myCarousel" class="carousel slide text-center" data-ride="carousel" style="margin-top:50px">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                <img src="images/deluxe/deluxe1.jpg" width="100%">
              </div>
              <div class="item">
                <img src="images/deluxe/deluxe2.jpg" width="100%">
              </div>
              <div class="item">
                <img src="images/deluxe/deluxe3.jpg" width="100%">
              </div>
			  <div class="item">
                <img src="images/deluxe/deluxe4.jpg" width="100%">
              </div>
            </div>
...
<div class="col-sm-12 col-xs-12">
      ...
      <input name="tombol2" value="Kirim" type="submit"></form></div>
      <div id="publishcomment">
      <?php $query_mysql = mysqli_query($con,"select * from com_deluxe") or die(mysql_error());
...
<div class="col-sm-12 col-xs-12">
      <div class="desc">
        ...
        <div style="margin-left:15px">
          <h5>Harga :</h5>
          <h3>RP. 3.200.000,00 / bulan</h3>
          <h5>Status :</h5>
          <h3 style="color:#E74C3C ">PENUH <span class="glyphicon glyphicon-remove-circle" height="30px" width="30px"></span></h3> 
        </div>
      </div>
</div>
<div class="col-sm-12 col-xs-12" style="float:right; margin-top:-30px; color:#50585D">
      <div class="desc">
        <div style="margin-left:10px; margin-top:15px">
          ...
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> TV 22" dengan siaran tv kabel</p>
          ...
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Kulkas</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Free laundry untuk tamu bulanan</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Springbed serta bantal guling dan bedsheet</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Full furnish (almari, meja tulis, kursi)</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Kamar mandi di dalam kamar</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Full AC dan kamar yang berventilasi baik</p>
        </div>
      </div>
</div>
