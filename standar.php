...
<div class="col-sm-8 col-xs-12">
        ...
        <div id="myCarousel" class="carousel slide text-center" data-ride="carousel" style="margin-top:50px">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                <img src="images/standar/standar1.jpg" width="100%">
              </div>
              <div class="item">
                <img src="images/standar/standar2.jpg" width="100%">
              </div>
              <div class="item">
                <img src="images/standar/standar3.jpg" width="100%">
              </div>
			  <div class="item">
                <img src="images/standar/standar4.jpg" width="100%">
              </div>
            </div>
    ...
    <div class="col-sm-12 col-xs-12">
      ...
      <input name="tombol3" value="Kirim" type="submit"></form></div>
      <div id="publishcomment">
      <?php $query_mysql = mysqli_query($con,"select * from com_stn") or die(mysql_error());
...
<div class="col-sm-12 col-xs-12" style="float:right; margin-top:-30px; color:#50585D">
      <div class="desc">
        <div style="margin-left:10px; margin-top:15px">
          ...
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> TV 22" </p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Free wifi di semua area</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Kamar mandi di dalam</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Layanan laundry untuk tamu bulanan</p>
          <p style="padding:2px"><span class="glyphicon glyphicon-ok-sign"></span> Springbed dan bantal guling</p>
